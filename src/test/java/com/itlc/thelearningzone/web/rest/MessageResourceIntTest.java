...
import com.itlc.thelearningzone.repository.MessageRepository;
import com.itlc.thelearningzone.service.MessageService;
...
public class MessageResourceIntTest {
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getTag()).isEqualTo(DEFAULT_TAG);
        assertThat(testMessage.getReason()).isEqualTo(DEFAULT_REASON);
    ...
    public void updateMessage() throws Exception {
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getTag()).isEqualTo(UPDATED_TAG);
        assertThat(testMessage.getReason()).isEqualTo(UPDATED_REASON);
