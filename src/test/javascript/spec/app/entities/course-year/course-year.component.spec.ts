...
import { CourseYearComponent } from 'app/entities/course-year/course-year.component';
...
describe('Component Tests', () => {
    describe('CourseYear Management Component', () => {
        let comp: CourseYearComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CourseYearComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.courseYears[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
