...
import { SemesterGroupComponent } from 'app/entities/semester-group/semester-group.component';
...
describe('Component Tests', () => {
    describe('SemesterGroup Management Component', () => {
        let comp: SemesterGroupComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SemesterGroupComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.semesterGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
