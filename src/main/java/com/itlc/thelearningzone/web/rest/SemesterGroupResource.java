...
public class SemesterGroupResource {
    ...
    @Timed
    public ResponseEntity<List<SemesterGroupDTO>> getAllSemesterGroups(Pageable pageable) {
        log.debug("REST request to get a page of SemesterGroups");
        Page<SemesterGroupDTO> page = semesterGroupService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/semester-groups");
